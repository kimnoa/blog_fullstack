...
public interface BoardListViewRepository extends JpaRepository<BoardListViewEntity, Integer> {
    ...
    List<BoardListViewEntity> findTop3ByWriteDatetimeGreaterThanOrderByFavoriteCountDescViewCountDescCommentCountDescWriteDatetimeDesc(LocalDateTime writeDatetime);
